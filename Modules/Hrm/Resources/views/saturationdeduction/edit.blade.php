...
<div class="modal-body">
    <div class="row">
        ...
        <div class="row main-div-threshoul">
            @if (!empty($saturationdeduction->deduction_ranges))
                @foreach ($saturationdeduction->deduction_ranges as $range)
                    <div class="dynamic-fields-row row">
                        <div class="col-md-4">
                            <div class="form-group">
                                {{ Form::label('range_start[]', __('Start Range'), ['class' => 'form-label']) }}
                                {{ Form::number('range_start[]', $range['range_start'], ['class' => 'form-control ', 'required' => 'required', 'placeholder' => 'Enter Range Start', 'min' => '0']) }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {{ Form::label('range_end[]', __('End Range'), ['class' => 'form-label']) }}
                                {{ Form::number('range_end[]', $range['range_end'], ['class' => 'form-control ', 'required' => 'required', 'placeholder' => 'Enter Range End', 'min' => '0']) }}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                {{ Form::label('deduction_amount[]', __('Deduction'), ['class' => 'form-label']) }}
                                {{ Form::number('deduction_amount[]', $range['deduction_amount'], ['class' => 'form-control ', 'required' => 'required', 'placeholder' => 'Deduction value', 'min' => '0', 'max' => '100']) }}
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
