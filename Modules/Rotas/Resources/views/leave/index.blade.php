                    ...
                    <table class="table mb-0 pc-dt-simple" id="assets">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('status') }}</th>
                                @if (Gate::check('rotaleave edit') || Gate::check('rotaleave delete') || Gate::check('rotaleave approver manage'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if (in_array(\Auth::user()->type, \Auth::user()->not_emp_type))
                                    <td>{{ !empty( Modules\Rotas\Entities\Employee::getEmployee($leave->user_id)) ? Modules\Rotas\Entities\Employee::getEmployee($leave->user_id)->name : '--' }}</td>
                                @endif
                                <td>{{ !empty(Modules\Rotas\Entities\Leave::getLeaveType($leave->leave_type_id)) ? Modules\Rotas\Entities\Leave::getLeaveType($leave->leave_type_id)->title : '' }}
                                </td>
