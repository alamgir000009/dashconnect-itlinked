                        ...
                        <div class="form-group col-md-3 my-auto ">
                            <div class="rotas_filter_main_div">
                                ...
                                {{-- <div class="d-inline-block ">
                                    <button type="button" class="add_remove_employee p-0 border-0 " data-size="lg"
                                        data-ajax-rota="true" data-title="{{ __('Add/Remove Employee') }}"
                                        data-url="{{ route('rotas.add_remove_employee_popup') }}"><span
                                ...
                                <div class="btn-group card-option rotas_filter">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" style="">
                                        ...
                                        @endcan
                                        @can('rota hide/show availability')
                                            <a href="#"
...
@push('scripts')
    ...
    <script>
        ...
        @if (Gate::check('rota copy-week-shift'))
            function dragdrop() {
