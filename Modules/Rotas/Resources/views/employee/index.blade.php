                        ...
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            <thead>
                                <tr>
                                    ...
                                    @if (Gate::check('rotaemployee edit') || Gate::check('rotaemployee delete'))
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <td>
                                            {{ !empty(Modules\Rotas\Entities\Employee::Branchs($employee->branch_id)) ? Modules\Rotas\Entities\Employee::Branchs($employee->branch_id)->name : '--' }}
                                        </td>
                                        <td>
                                            {{ !empty(Modules\Rotas\Entities\Employee::Departments($employee->department_id)) ? Modules\Rotas\Entities\Employee::Departments($employee->department_id)->name : '--' }}
                                        </td>
                                        <td>
                                            {{ !empty(Modules\Rotas\Entities\Employee::Designations($employee->designation_id)) ? Modules\Rotas\Entities\Employee::Designations($employee->designation_id)->name : '--' }}
