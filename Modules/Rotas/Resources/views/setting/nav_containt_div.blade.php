...
<div class="card" id="rotas-sidenav">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            {{-- <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-check form-switch d-inline-block mx-2">
                    {!! Form::checkbox('emp_can_see_all_designation', 1, !empty(company_setting('emp_can_see_all_designation')) ? 1 : 0, ['required' => false, 'class' => 'custom-control-input form-check-input', 'id' => 'emp_can_see_all_designation', 'role' => 'switch']) !!}
                    {{ Form::label('emp_can_see_all_designation', __('Employees can view the rotas of designation they are not assigned to'), ['class' => 'custom-label text-dark']) }}
                </div>
            </div> --}}
            <br><br><br>
            <div class="col-xs-12 col-sm-12 col-md-12">
