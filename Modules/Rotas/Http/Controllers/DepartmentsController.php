...
class DepartmentsController extends Controller
{
    ...
    {
        if(Auth::user()->can('rotadepartment manage'))
        {
    ...
    {
        if(Auth::user()->can('rotadepartment create'))
        {
    ...
    {
        if(Auth::user()->can('rotadepartment edit'))
        {
    ...
    {
        if(Auth::user()->can('rotadepartment delete'))
        {
            if($department->created_by == creatorId() &&  $department->workspace  == getActiveWorkSpace())
            {
    ...
    {
        if(Auth::user()->can('departments name edit'))
        {
