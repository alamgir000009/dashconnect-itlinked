...
class RotaleaveController extends Controller
{
    ...
    {
        if(Auth::user()->can('rotaleave manage'))
        {
    ...
    {
        if(Auth::user()->can('rotaleave create'))
        {
            if(!in_array(Auth::user()->type, Auth::user()->not_emp_type))
            {
    ...
    {
        if(Auth::user()->can('rotaleave edit'))
        {
            $leave = Leave::find($id);
    ...
    {
        if(Auth::user()->can('rotaleave delete'))
        {
            $leave = Leave::find($id);
    ...
    {
        if(Auth::user()->can('rotaleave approver manage'))
        {
            $leave     = Leave::find($id);
